  ...
  cards: [
    {
      ...
      label: { es: "FRONTEND<br />& PRODUCTO", en: "FRONTEND<br />& PRODUCT" } satisfies L,
    },
    {
      href: "#casos",
      ...
      label: { es: "BACKEND<br />& DATOS", en: "BACKEND<br />& DATA" } satisfies L,
    },
    {
      href: "#stack",
      ...
      label: { es: "CLOUD<br />& IA", en: "CLOUD<br />& AI" } satisfies L,
    },
  ],
};
